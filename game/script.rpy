...
label a42:
    show helen head_g body_af at left 
...
label a43:
    ...
    show helen head_f body_ad at left
    helen "— Кто вы?"
...
label ant_puzzle_success:
    ...
    narrator "Каждый из нас внимательно изучил найденный муравьями путь и запомнил его, чтобы не потеряться, если кого-то из нас поймают культисты."
